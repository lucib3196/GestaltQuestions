    ...
    <section className="rounded-2xl border border-border bg-surface p-5 shadow-soft backdrop-blur-md">
      <div className="mb-5 flex items-start justify-between gap-4">
        ...
        <button
          ...
          disabled={true}
          className={clsx(
            "inline-flex items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium text-text-muted transition-colors hover:bg-surface-muted hover:text-text cursor-not-allowed",
          )}
        >
