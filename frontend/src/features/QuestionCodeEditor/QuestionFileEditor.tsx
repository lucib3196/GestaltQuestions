...
import { useActiveQuestionFile, useEditableQuestionFiles, useActiveFilePreview } from "./hooks/hooks";
...
function QuestionFileEditorBase({ qid }: QuestionFileEditorBaseProps) {
    ...
    const { files, setFiles, updateFileContent } = useEditableQuestionFiles(fileData);
    ...
    if (preview.type === "image") {
        ...
        editorContent = (
            <CodeEditor
                ...
                setValue={(content) =>
                    updateFileContent(activeFile.filename, content)
                }
