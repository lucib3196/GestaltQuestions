...
type QuestionLibraryToolbarExtraActionId =
  | "delete"
  | "collections"
...
export type QuestionLibraryToolbarActionId =
  | BaseQuestionTableToolbarActionId
  | QuestionLibraryToolbarExtraActionId;
...
] as const satisfies readonly ToolBarActionConfig<QuestionLibraryToolbarActionId>[];
