...
type PLSymbolicInputFieldProps = {
  answerName: string;
  label: string | number;
  value: string | number;
  comparison: string;
...
export default function PLSymbolicInputField({
  answerName,
  className = "",
  comparison,
  digits,
      ...
      <div className={className}>
        ...
        >
          ...
          <input
            ...
            className={clsx(
              "min-w-0 bg-transparent px-3 py-2 font-mono text-sm text-text placeholder:text-text-soft focus:outline-none focus:ring-2 focus:ring-inset focus:ring-accent",
