...
export default function CodeEditorToolBar({ language, theme, setEditorTheme }: TooBarProps) {
    return <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border bg-surface-strong px-3 py-2">
        ...
        <div className="flex items-center gap-2">
            ...
            <select
                ...
                value={theme}
                onChange={(e) =>
                    setEditorTheme(e.target.value as EditorThemeKey)
                }
                className={clsx(
